...
const jsfile = [{"id":1,"first_name":"Chadwick","last_name":"Ayre","email":"cayre0@cam.ac.uk","gender":"Male","img_src":"https://robohash.org/corporisquiaperiam.png?size=50x50&set=set1","class":11,"marks":18,"passing":false,"city":"Moorreesburg"},
...
function CreatejsontableDATA(){
   var headers = Object.keys(jsfile[0])

   var headerRowelement = "<thead>"

   for(let i=0;i<headers.length;i++){
    headerRowelement += '<th>' +headers[0].toUpperCase() +   '</th>'
    headerRowelement += '<th>' +headers[1].toUpperCase() +   '</th>'
    headerRowelement += '<th>' +headers[4].toUpperCase() +   '</th>'
    headerRowelement += '<th>' +headers[6].toUpperCase()+   '</th>'
    headerRowelement += '<th>' +headers[7].toUpperCase() +   '</th>'
    headerRowelement += '<th>' +headers[8].toUpperCase() +   '</th>'
    headerRowelement += '<th>' +headers[3].toUpperCase() +   '</th>'
    break;
   }
   headerRowelement += '<thead>'
   ...
   for(var j=0;j<headers.length;j++){
    ...
    Alldata = '<td>' +jsfile[i][header] + '</td>'

   }
   Alldata += '</tbody>'
   }
   var table = document.getElementById('json-table');
   table.innerHTML = headerRowelement+Alldata;

} 
  window.onload = CreatejsontableDATA()